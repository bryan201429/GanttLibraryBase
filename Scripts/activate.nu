...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\soporte\Documents\MIS TESTS\djangoProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\soporte\Documents\MIS TESTS\djangoProject\Scripts\deactivate.nu'
